...
router.put("/:id", async (req, res) => {
  try {
    ...
    const updated = await Project.findByIdAndUpdate(req.params.id, updatedData, { new: true, runValidators: true })
...
router.patch("/:id/status", async (req, res) => {
  try {
    ...
    const updated = await Project.findByIdAndUpdate(req.params.id, { status }, { new: true, runValidators: true })
