    ...
    <section id="process" className="py-20 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h2 className="text-4xl lg:text-5xl font-bold text-black mb-4">My Design Process</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {processSteps.map((step, index) => {
            ...
            return (
              <Card
                key={index}
                className="p-6 hover:shadow-lg transition-all duration-300 relative overflow-hidden group border border-green-200 bg-gray-50"
              >
                {/* Decorative circle */}
                <div className="absolute top-0 right-0 w-20 h-20 bg-gradient-to-br from-green-500/10 to-black/10 rounded-full -mr-10 -mt-10 group-hover:scale-150 transition-transform duration-500"></div>

                <CardContent className="p-0 relative z-10">
                  <div className="flex items-center mb-4">
                    <div className="text-3xl font-bold text-green-600 mr-4">{step.step}</div>
                    <div className="p-2 bg-gradient-to-br from-green-600 to-black rounded-lg text-white">
                    ...
                    <div className="space-y-1">
                      {step.deliverables.map((deliverable, i) => (
                        <div key={i} className="flex items-center text-sm text-gray-700">
                          <div className="w-1.5 h-1.5 bg-gradient-to-r from-green-600 to-black rounded-full mr-2"></div>
                          {deliverable}
                        </div>
                      ))}
                    </div>
        ...
        {/* Process Timeline */}
        <div className="mt-16 bg-gradient-to-r from-green-50 to-gray-100 rounded-2xl p-8">
          <h3 className="text-2xl font-bold text-black text-center mb-8">Typical Project Timeline</h3>
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            <div className="text-center">
              <div className="text-2xl font-bold text-green-600">6-12</div>
              <div className="text-sm text-gray-700">Weeks Duration</div>
            </div>
            <div className="text-center">
              <div className="text-2xl font-bold text-green-600">3-5</div>
              <div className="text-sm text-gray-700">Review Cycles</div>
            </div>
            <div className="text-center">
