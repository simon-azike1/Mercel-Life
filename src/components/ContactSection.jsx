...
export default function ContactSection() {
  return (
    <section
      id="contact"
      className="py-20 bg-gradient-to-br from-white via-gray-200 to-green-100"
    >
            ...
            <div>
              ...
              <div className="flex space-x-4">
                <a
                  ...
                  className="p-3 bg-white rounded-full shadow-md hover:shadow-lg transition-shadow text-gray-600 hover:text-green-600"
                  target="_blank"
              ...
              <CardContent className="p-0">
                <form className="space-y-6">
                  ...
                  <div>
                    ...
                    <select className="w-full px-4 py-3 border-none rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent transition-colors">
                  ...
                  <Button className="w-full bg-gradient-to-r from-green-600 to-black hover:from-green-700 hover:to-black text-white py-3 text-lg">
                    Send Message
